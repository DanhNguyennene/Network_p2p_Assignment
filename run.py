...
if __name__ == "__main__":
    ...
    network.update_torrent_and_run(["./torrents/TO_BE_SHARED.torrent","./torrents/TO_BE_SHARED copy.torrent"])
    network.update_torrent_and_run(["./torrents/TO_BE_SHARED copy 2.torrent"])
